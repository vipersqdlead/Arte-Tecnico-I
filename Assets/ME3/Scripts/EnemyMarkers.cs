...
public class EnemyMarkers : MonoBehaviour
{
    ...
    {    
		...
		muzzleVel += player.gunsControl.baseVelocity;
            ...
            {
                Vector3 leadPos = Utilities.FirstOrderIntercept(player.transform.position, player.rb.linearVelocity, muzzleVel, targetLockedHub.transform.position, targetLockedHub.rb.linearVelocity);

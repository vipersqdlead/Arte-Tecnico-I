...
public class BombDropper : MonoBehaviour
{
    ...
    void CalculateTimeToTarget()
    {
        ...
        timeToTarget = Vector3.Distance(rb.transform.position, targetPosYCorrected) / rb.linearVelocity.magnitude;
    }
    ...
    void DropBomb()
    {
        ...
        bombRb.AddForce(rb.linearVelocity, ForceMode.VelocityChange);
    }
}

...
public class Radar_Missile : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        rb.linearDamping = Mathf.Clamp(turnDrag, newDrag, 1);
    ...
    Quaternion GuidancePN()
    {
        ...
        Vector3 missileVel = rb.linearVelocity;
    ...
    void Acquisition()
    {
        ...
        if (possibleTarget != null)
        {
            ...
            if (angleToMissile < 45f && closingSpeed - rb.linearVelocity.magnitude > 30f)
            {
	...
	void NotchFilter()
	{
		...
		if((closingSpeed - rb.linearVelocity.magnitude) < 30f)
		{
